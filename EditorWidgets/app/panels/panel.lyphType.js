...
var LyphTypePanel = (function (_super) {
    ...
    LyphTypePanel.prototype.addTemplate = function (property) {
    ...
    LyphTypePanel.prototype.removeTemplate = function (property, item) {
        ...
        _super.prototype.updateProperty.call(this, property, null);
    };
    ...
    LyphTypePanel = __decorate([
        core_1.Component({
            ...
            directives: [panel_materialType_1.MaterialTypePanel, component_select_1.MultiSelectInput, component_select_1.SingleSelectInput, repo_template_1.RepoTemplate, template_borderType_1.BorderTemplatePanel, component_toolbars_1.EditToolbar],
