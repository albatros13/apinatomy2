...
var RepoLyphType = (function (_super) {
    __extends(RepoLyphType, _super);
    function RepoLyphType() {
        _super.apply(this, arguments);
    }
    RepoLyphType = __decorate([
        core_1.Component({
            ...
            directives: [repo_wrapper_1.RepoWrapper, repo_wrapper_1.ItemHeader, repo_wrapper_1.List, panel_lyphType_1.LyphTypePanel, accordion_1.ACCORDION_DIRECTIVES, common_1.CORE_DIRECTIVES, common_1.FORM_DIRECTIVES, ng2_dnd_1.DND_DIRECTIVES]
        }), 
        __metadata('design:paramtypes', [])
    ], RepoLyphType);
    return RepoLyphType;
}(repo_wrapper_1.RepoWrapper));
exports.RepoLyphType = RepoLyphType;
//# sourceMappingURL=repo.lyphType.js.map