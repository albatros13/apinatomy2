...
var panel_publication_1 = require('./panel.publication');
var RepoPublication = (function (_super) {
    __extends(RepoPublication, _super);
    function RepoPublication() {
        _super.apply(this, arguments);
    }
    RepoPublication = __decorate([
        core_1.Component({
            ...
            directives: [repo_wrapper_1.RepoWrapper, repo_wrapper_1.ItemHeader, repo_wrapper_1.List, panel_publication_1.PublicationPanel, accordion_1.ACCORDION_DIRECTIVES, common_1.CORE_DIRECTIVES, common_1.FORM_DIRECTIVES, ng2_dnd_1.DND_DIRECTIVES]
        }), 
        __metadata('design:paramtypes', [])
    ], RepoPublication);
    return RepoPublication;
}(repo_wrapper_1.RepoWrapper));
exports.RepoPublication = RepoPublication;
//# sourceMappingURL=repo.publication.js.map