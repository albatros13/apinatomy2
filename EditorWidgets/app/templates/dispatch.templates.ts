...
import {BorderTemplatePanel} from './template.borderType';
import {ProcessTemplatePanel} from './template.processType';
import {CausalityTemplatePanel} from './template.causalityType';
import {GroupTemplatePanel} from './template.groupType';
import {OmegaTreeTemplatePanel} from './template.omegaTreeType';
import {LyphTemplatePanel} from './template.lyphType';
import {CylindricalLyphTemplatePanel} from './template.cylindricalLyphType';
