...
var RepoType = (function (_super) {
    __extends(RepoType, _super);
    function RepoType() {
    ...
    RepoType = __decorate([
        core_1.Component({
            ...
            directives: [repo_wrapper_1.RepoWrapper, repo_wrapper_1.ItemHeader, repo_wrapper_1.List, panel_type_1.TypePanel, accordion_1.ACCORDION_DIRECTIVES, common_1.CORE_DIRECTIVES, common_1.FORM_DIRECTIVES, ng2_dnd_1.DND_DIRECTIVES]
        }), 
