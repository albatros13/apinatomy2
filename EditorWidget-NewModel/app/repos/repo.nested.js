...
var RepoNested = (function (_super) {
    ...
    function RepoNested(toastyService) {
        _super.call(this);
    ...
    RepoNested.prototype.ngOnInit = function () {
        ...
        if (this.types.length == 1) {
            this.ts = utils_model_1.model[this.types[0]].p('all').subscribe(function (data) { _this.allItems = data; });
        }
        else {
            if (this.types.length > 1) {
                var setToArray_1 = new pipe_general_1.SetToArray();
                var filterByClass_1 = new pipe_general_1.FilterByClass();
                this.ts = utils_model_1.model.Template.p('all').subscribe(function (data) { _this.allItems = new Set(filterByClass_1.transform(setToArray_1.transform(data), _this.types)); });
            }
        }
    };
    ...
    RepoNested.prototype.onDragStart = function () {
        //TODO: swap 2 elements?
    };
    RepoNested.prototype.onDragEnd = function () {
