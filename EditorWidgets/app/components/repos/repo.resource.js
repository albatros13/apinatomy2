...
var RepoResource = (function (_super) {
    ...
    RepoResource = __decorate([
        core_1.Component({
            ...
            directives: [repo_wrapper_1.RepoWrapper, component_general_1.ItemHeader, panel_resource_1.ResourcePanel, accordion_1.ACCORDION_DIRECTIVES, common_1.CORE_DIRECTIVES, common_1.FORM_DIRECTIVES, ng2_dnd_1.DND_DIRECTIVES]
        }), 
