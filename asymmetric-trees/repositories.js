...
//Tree
////////////////////////////////////////////////////////////////
//numLevels, branchingFactor, meanLengths, diameters

var l1 = new TreeLevel(1, 2, new NormalDistribution(40, 20), 0);
var l2 = new TreeLevel(2, 2, new UniformDistribution(40, 20), 0.5);
var l3 = new TreeLevel(3, 1.5, new NormalDistribution(30, 20), 0);
var l4 = new TreeLevel(4, 1, new UniformDistribution(50, 20), 0);

var treeLevels = [l1, l2, l3, l4];
var tree = new AsymmetricTree("t1", "Tree 1", 4, treeLevels);
var tree1 = new AsymmetricTree("t2", "Tree 2", 4, treeLevels);
var treeRepo = new TreeRepo([tree, tree1]);
