...
import {IResource, IExternalResource} from "../providers/service.apinatomy2";
...
@Component({
        ...
        <div class="panel-body">
          ...
          <div class="panel-content">
              ...
              <div class="input-control" *ngIf="includeProperty('equivalence')">
                <label for="name">Equivalence: </label>
                <select-input [item]="item.equivalence"></select-input>
              </div>
              <div class="input-control" *ngIf="includeProperty('weakEquivalence')">
                <label for="name">Weak equivalence: </label>
                <select-input [item]="item.weakEquivalence"></select-input>
              </div>
  ...
  `,
  directives: [ResourceToolbar, SelectInput]
})
