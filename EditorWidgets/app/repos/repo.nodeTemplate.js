...
var RepoTemplate = (function (_super) {
    ...
    function RepoTemplate() {
        ...
        this.types = [service_apinatomy2_1.TemplateName.NodeTemplate];
    }
    RepoTemplate.prototype.getIcon = function (item) {
        return "images/nodeType.png";
    };
    RepoTemplate.prototype.onAdded = function () {
        var newItem = new service_apinatomy2_1.NodeTemplate({ name: "New node template" });
    ...
    RepoTemplate = __decorate([
        core_1.Component({
            ...
            directives: [repo_abstract_1.ItemHeader, component_toolbars_1.EditToolbar, component_toolbars_1.FilterToolbar,
                template_nodeType_1.NodeTemplatePanel, accordion_1.ACCORDION_DIRECTIVES, common_1.CORE_DIRECTIVES, common_1.FORM_DIRECTIVES, ng2_dnd_1.DND_DIRECTIVES],
...
//# sourceMappingURL=repo.nodeTemplate.js.map